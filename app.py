...
def preprocess(q):
    ...
    # Decontracting words (simplified for space)
    contractions = { 
    "ain't": "am not",
    "aren't": "are not",
    "can't": "can not",
...
# Inputs from user
q1 = st.text_input("Enter the first sentence")
q2 = st.text_input("Enter the second sentence")

if st.button("Check for Plagiarism"):
    if q1 and q2:
        result = model.predict(query_point_creator(q1, q2))[0]
        if result == 1:
